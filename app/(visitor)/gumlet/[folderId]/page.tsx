...
export default function GumletFolderGalleryPage() {
    ...
    return (
        <div className="min-h-screen pb-32">
            <header className="bg-[#6B46C1] text-white border-b border-purple-600 sticky top-0 z-40">
                <div className="max-w-7xl mx-auto px-4 py-4">
                    <h1 className="text-2xl font-bold">Gumlet Gallery</h1>
                    <p className="text-sm text-purple-100 mt-1">Select photos from your Gumlet folder</p>
                    <p className="text-xs text-purple-200 mt-1 font-mono">Folder ID: {folderId}</p>
                </div>
            </header>
