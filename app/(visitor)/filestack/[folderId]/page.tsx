...
export default function FilestackFolderGalleryPage() {
        ...
        <div className="min-h-screen pb-32">
            <header className="bg-[#FF6B35] text-white border-b border-orange-600 sticky top-0 z-40">
                <div className="max-w-7xl mx-auto px-4 py-4">
                    ...
                    <p className="text-sm text-orange-100 mt-1">Select photos from your Filestack folder</p>
                    <p className="text-xs text-orange-200 mt-1 font-mono">Folder ID: {folderId}</p>
                </div>
            </header>
