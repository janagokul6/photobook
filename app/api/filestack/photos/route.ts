...
import { listFilestackImages } from '@/lib/filestack';
...
export async function GET(request: NextRequest) {
    try {
        ...
        // Fetch images from Filestack (library or folder)
        const result = await listFilestackImages(folderId, pageToken, pageSize);

        // Map Filestack images to the expected format
        ...
        console.error('Error fetching Filestack photos:', error);
